                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="../img/volcano/logo.png" style="width:200px; ">
<!--  <i class="fa fa-bus" 
...
<!-- <form action="login.php?op=in" method="POST" class="apply_form">
...
<button class="boxed-btn3" type="submit"><i class="fa fa-unlock"></i> Login Now</button>
</div>
</div>
